...
// This is used to calculate the length of an uploaded video
  ...
  return (
    <>
      ...
      >
            ...
            <input
              ...
              onChange={async (event) => {
                if (event.target.files && event.target.files[0]) {
                  ...
                  {/* We’re only interested in the length in seconds*/}
        ...
        {/*The upload button is disabled until we have all 3 fields 
          and 
          This is to display a visual indication that the form can’t be submitted
          until we have all 3 items
        */}
        <button
